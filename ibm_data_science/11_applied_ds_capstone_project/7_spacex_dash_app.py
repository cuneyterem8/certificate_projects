...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.RangeSlider(id='payload-slider',
                                                ...
                                                marks={100: '100', 5000: '5000', 10000: '10000'},
...
def pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        filtered_df = filtered_df.groupby(['Launch Site', 'class']).size().reset_index(name='c_count')
        fig = px.pie(filtered_df, values='c_count', 
        names='class',
